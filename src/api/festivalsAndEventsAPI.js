...
const subTitle1 = "Events Guide";
const subTitle2 = "The Saratoga Farmers’ Market";
const subTitle3 = "January";
const subTitle4 = "March - April";
const subTitle5 = "June";
const subTitle6 = "September";

const semiSubTitle1 = "Ongoing Events Throughout the Year";
const semiSubTitle2 = "Annual Events";
const semiSubTitle3 = "Winter";
const semiSubTitle4 = "Spring";
const semiSubTitle5 = "Summer";
const semiSubTitle6 = "Fall";
